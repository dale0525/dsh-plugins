...
export const zh = {
  ...
  'channels.apiUrlFullHint': '开启后精确请求此地址，不再拼接 /images/generations 或 /images/edits，并跳过 /models 自动检测；请手动维护模型目录。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'channels.apiUrlFullHint': 'Use this URL verbatim without appending /images/generations or /images/edits. /models detection is skipped, so maintain the model catalog manually.',
...
export const ru: Record<keyof typeof zh, string> = {
  ...
  'channels.apiUrlFullHint': 'Использовать URL как есть, без добавления /images/generations или /images/edits. Автопоиск /models пропускается, поэтому ведите каталог моделей вручную.',
