...
export const uiZh = {
  ...
  'sync.lock.recovered': '残留锁已回收，可以继续推送或拉取。',
  ...
  'sync.recovery.dismissFailed': '未解除：该恢复事项已不存在或无法放弃，请刷新后重试。',
  'sync.recovery.op.syncPush': '同步推送',
  'sync.recovery.op.syncPull': '同步拉取',
  'sync.recovery.op.other': '配置修改',
  'sync.recovery.badge.needsAttention': '待人工处理',
  'sync.recovery.badge.recovering': '恢复中断',
...
export const uiEn: Record<UiTextKey, string> = {
  ...
  'sync.lock.recovered': 'Stale lock recovered — you can push or pull again.',
  ...
  'sync.recovery.dismissFailed': 'Not removed: this recovery item no longer exists or cannot be abandoned. Refresh and try again.',
  'sync.recovery.op.syncPush': 'Sync push',
  'sync.recovery.op.syncPull': 'Sync pull',
  'sync.recovery.op.other': 'Config change',
  'sync.recovery.badge.needsAttention': 'Needs attention',
  'sync.recovery.badge.recovering': 'Recovery interrupted',
