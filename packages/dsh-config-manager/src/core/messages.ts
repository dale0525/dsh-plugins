...
export const zh = {
  ...
  'adapter.dirsExcluded': '{type} 分区：已按设计跳过 {count} 个运行时缓存/历史目录（其内容有意不进备份，不影响其他设备直接使用）—— {detail}',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'adapter.dirsExcluded': '{type}: skipped {count} runtime cache/history director(ies) by design (intentionally not in this backup; does not affect direct use on other devices) — {detail}',
