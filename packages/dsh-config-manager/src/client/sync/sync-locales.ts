...
export const zh = {
  ...
  'mode.sectionsHint': '全部推荐分区都可勾选同步；快照为明文，仅同步到你自己配置的私有通道。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'mode.sectionsHint': 'Every recommended section can be selected; snapshots are plaintext and go only to the private channel you configure.',
