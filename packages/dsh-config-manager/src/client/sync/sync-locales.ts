...
export const zh = {
  ...
  'channel.perChannelHint': 'GitHub 与 WebDAV 通道的自动同步、同步模式与远端快照各自独立配置。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'channel.perChannelHint': 'Auto sync, sync mode and remote snapshots are configured independently for the GitHub and WebDAV channels.',
